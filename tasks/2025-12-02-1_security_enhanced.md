...
### 1. 로그인 해시를 bcrypt/argon2로 교체하고 SESSION_COOKIE_SECURE 기본 True, 로그인 rate limit 적용
- **우선순위**: high
- **마감일**: 2025-12-09
- **출처**: handoff
...
### 2. bcrypt/argon2 해시 및 secure cookie/rate limit이 실제로 적용되었는지 테스트 증적을 첨부해주세요.
- **우선순위**: high
- **마감일**: TBD
- **출처**: qa_release
...
- **마감일**: TBD
- **출처**: backend
- **산출물**: [{'type': 'test', 'uri': 'pytest', 'note': 'pytest -q'}]

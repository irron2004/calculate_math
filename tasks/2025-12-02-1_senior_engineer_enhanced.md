...
### 1. Review the new skill-tree fallbacks, generator script, and regression tests before merging.
- **우선순위**: medium
- **마감일**: TBD
- **출처**: backend

### 2. Review the new seed fallback banner copy and analytics semantics
- **우선순위**: medium
- **마감일**: TBD
- **출처**: frontend
